public class PatternA {
    public static void main(String[] args) {
        ...
        for(int i=0;i<n;i++){
            ...
            System.out.print("   ");
            for(int j=0;j<n;j++){
                if(i==0 && j<(n-1)/2 || j==0 || i==(n-1)/2 && j<(n-1)/2 || j==(n-1)/2 && i>0 && i<(n-1)/2 || i==n-1 && j<(n-1)/2 || j==(n-1)/2 && i>(n-1)/2){
                    System.out.print("*");
                }
                else{
                    System.out.print(" ");
            ...
            System.out.print("   ");
            for(int j=0;j<n;j++){
                if(i==0 && j<=(n-1)/2 || j==0 || i==n-1 && j<=(n-1)/2 || i==(n-1)/2 && j>2 && j<=(n-1)/2 || j==(n-1)/2 && i>(n-1)/2){
                    System.out.print("*");
                }
                else{
                    System.out.print(" ");
